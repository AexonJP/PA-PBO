...
public class rincianAnimeAdmin{
	Integer ids;
    String juduls;
    Float ratings;
    Integer episodes;
...
// jScrollPane.getHorizontalScrollBar().setPreferredSize(new Dimension(0, 10));
        ...
        btHapus.addActionListener(new ActionListener() {
	        ...
	        try {
	            ...
	            PreparedStatement stmt = connection.prepareStatement("DELETE FROM `animes` WHERE `id` = "+id);
